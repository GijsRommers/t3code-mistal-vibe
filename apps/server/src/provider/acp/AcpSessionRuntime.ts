...
export interface AcpSessionRuntimeOptions {
  ...
  /**
   * ACP authentication method to invoke before opening the session.
   * Omit this for agents such as Vibe that read persisted credentials during
   * session creation: their interactive authenticate method opens a browser
   * and must never run from background probes.
   */
